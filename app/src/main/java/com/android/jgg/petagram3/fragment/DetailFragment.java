...
import com.android.jgg.petagram3.adapter.DetailAdapter;
...
public class DetailFragment extends Fragment implements Updatable {
    ...
    private MascotaService srv = null;
    public DetailFragment() {
        srv = MascotaService.getInstance();
    ...
    public void update() {
        ...
        civ.setImageResource(mascota.getIdFoto());
